...
describe('preact', () => {
  describe('Image', () => {
    ...
    it('should run callback ref cleanup on unmount', () => {
      ...
      expect(imgRef).toHaveBeenCalledOnce()

      unmount()

      expect(cleanup).toHaveBeenCalledOnce()
      // With a cleanup returned, Preact must not call the ref with `null`.
      expect(imgRef).toHaveBeenCalledOnce()
    })
    ...
    it('should keep camel-case fetchPriority when priority toggles off', () => {
    ...
    it('should pass class and imgRef through', () => {
